...
const customOpenSourceSolutions = [
  {
    ...
    description: "End-to-end product engineering: discovery, design, development, QA, and ongoing evolution with AI-powered business intelligence.",
  ...
  },
  {
    ...
    description: "Tailor open-source platforms with custom modules, integrations, and enterprise-grade support for scalable solutions.",
  ...
  },
  {
    ...
    description: "Cloud strategy, migration, and managed services for scalable, cost-efficient operations across all major platforms.",
    image: cloudImage,
    features: [
...
const routes = ['/web-development', '/app-development', '/ecommerce', '/custom-software', '/open-source', '/cloud-strategy'];

const supportSolutions = [
  {
    icon: Target,
    title: "IT Consulting",
    description: "Strategic technology advisory to align IT with business objectives and drive digital transformation.",
    features: [
  ...
  },
  {
    ...
    description: "Seamlessly connect disparate systems and automate workflows for improved operational efficiency.",
    features: [
      "API integration",
  ...
  },
  {
    ...
    description: "24/7 technical support and monitoring to keep your systems running smoothly and efficiently.",
    features: [
      "24/7 help desk",
      "System monitoring",
      "Security support",
...
const supportRoutes = ['/it-consulting', '/system-integration', '/technical-support'];

const ITServices = () => {
  const { ref: heroRef, isVisible: heroVisible } = useScrollAnimation();
  const { ref: webMobileRef, isVisible: webMobileVisible } = useScrollAnimation();
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-800 leading-relaxed">
                  We deliver end-to-end software engineering—from discovery and design to build, deploy, and manage. Comprehensive solutions including custom development, open source customization, and enterprise modernization with proven expertise across 200+ successful projects.
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-primary" />
                    <span>Custom Software Development with AI-powered Business Intelligence</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-primary" />
                    <span>Open Source Customization and Legacy System Modernization</span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Web & Mobile Development</h2>
            ...
            <p className="text-xl text-gray-800 max-w-3xl">
              Modern web and mobile solutions built for performance, scalability, and user experience across all devices and platforms.
            </p>
          </div>

          <div 
            ref={webMobileRef}
            className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 fade-up ${webMobileVisible ? 'visible' : ''}`}
          >
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Custom Software & Enterprise Solutions</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-primary to-secondary rounded-full mb-6"></div>
            <p className="text-xl text-gray-800 max-w-3xl">
              Enterprise-grade custom software development, open source customization, and cloud infrastructure solutions for scalable business growth.
            </p>
          </div>

          <div 
            ref={customRef}
            className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 fade-up ${customVisible ? 'visible' : ''}`}
          >
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Comprehensive IT consulting and support services to optimize your technology infrastructure and drive business success.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-foreground">Support Solutions</h2>
            <p className="text-xl text-gray-800 max-w-3xl mx-auto">
              Comprehensive IT consulting and support services to optimize your technology infrastructure.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {supportSolutions.map((service, index) => {
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl text-gray-800">
              Let's discuss how our comprehensive IT services can help accelerate your digital transformation 
              and drive your business forward with proven enterprise solutions.
            </p>
