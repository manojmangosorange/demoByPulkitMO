            ...
            <div className="lg:col-span-1 order-1 lg:order-2">
              <div className="bg-gradient-to-br from-primary to-primary-glow rounded-2xl p-6 sm:p-8 h-full shadow-xl">
                ...
                <div className="space-y-4 sm:space-y-6">
                  {/* Address Card */}
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-3 sm:p-4 hover:scale-105 transition-all duration-300 cursor-pointer group" onClick={() => window.open('https://www.google.com/maps/place/28°36\'52.0\"N+77°23\'27.1\"E/@28.6160669,77.387332,1477m/data=!3m1!1e3!4m4!3m3!8m2!3d28.6144436!4d77.3908516?hl=en&entry=ttu&g_ep=EgoyMDI1MDkwOC4wIKXMDSoASAFQAw%3D%3D', '_blank')}>
                  ...
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden hover:scale-105 transition-all duration-300 cursor-pointer group" onClick={() => window.open('https://www.google.com/maps/place/28°36\'52.0\"N+77°23\'27.1\"E/@28.6160669,77.387332,1477m/data=!3m1!1e3!4m4!3m3!8m2!3d28.6144436!4d77.3908516?hl=en&entry=ttu&g_ep=EgoyMDI1MDkwOC4wIKXMDSoASAFQAw%3D%3D', '_blank')}>
