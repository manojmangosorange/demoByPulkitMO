...
import teamImage from "@/assets/professional-team-hero.webp";
  ...
  const whyChooseUs = [
    {
      ...
      title: "Establishment",
      description:
        "Founded in 2017, backed by over 100 years of combined industry experience",
    },
    {
      icon: Award,
      title: "Top Quality IT Solutions",
      description:
        "Top-quality IT solutions and support across all kinds of industries",
    },
    {
      icon: Headphones,
      title: "Dedicated Support Units",
      description:
        "Dedicated Sales & Support Team. Relationships & Customer Satisfaction",
    },
    {
      icon: Globe,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="page-top-spacing">
        ...
        <section
          ref={heroRef}
          className={`pb-16 px-4 fade-up ${heroVisible ? "visible" : ""}`}
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-800 mb-8">
                  At MangosOrange, we connect innovative businesses with
                  top-tier tech talent and deliver tailored IT solutions that
                  make a difference. We're not just another agency — we're your
                  growth partner.
                </p>
              </div>
        ...
        <section
          ref={whyChooseRef}
          className={`py-16 px-4 bg-accent/30 fade-up ${
            whyChooseVisible ? "visible" : ""
          }`}
        >
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {whyChooseUs.map((item, index) => (
                <Card
                  key={index}
                  className="rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 ease-out bg-card/50 backdrop-blur"
                >
        ...
        <section
          ref={strengthRef}
          className={`py-16 px-4 fade-up ${strengthVisible ? "visible" : ""}`}
        >
          <div className="container mx-auto max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-800 leading-relaxed">
                  Our Qualities Are The Texture Of Our Systems & Services. They
                  Tie Us Together Paying Little Mind To Where Or How We Work And
                  Position Us To Prevail On Our Change Venture. Are The Texture
                  Of Our Systems & Services. They Tie Us Together Paying Little
                  Heed To Where Or How We Work And Position Us To Prevail On Our
                  Change Venture.
                </p>
              </div>
            </div>
        ...
        <section
          ref={ctaRef}
          className={`py-16 px-4 bg-gradient-to-r from-primary/10 to-secondary/10 fade-up ${
            ctaVisible ? "visible" : ""
          }`}
        >
