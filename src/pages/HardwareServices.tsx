...
const hardwareCategories = [
  {
    ...
    description: "High-performance desktops and workstations for business productivity and specialized applications.",
    features: [
      "Custom PC builds",
  ...
  },
  {
    ...
    description: "Laptops, tablets, and mobile devices for flexible workforce and remote collaboration.",
    features: [
      "Business laptops",
      "Tablet solutions",
  ...
  },
  {
    ...
    description: "Enterprise servers, storage solutions, and data center infrastructure for scalable operations.",
    features: [
      "Rack servers",
      "Storage arrays",
      "Network switches",
...
const networkingSecurity = [
  {
    ...
    description: "Complete networking solutions including switches, routers, and wireless systems for seamless connectivity.",
    features: [
      "Managed switches",
      "Enterprise routers",
  ...
  },
  {
    ...
    description: "Physical security solutions including firewalls, access control, and surveillance systems.",
    features: [
      "Hardware firewalls",
  ...
  },
  {
    ...
    description: "Advanced CCTV systems and monitoring solutions for comprehensive security coverage.",
    features: [
      "IP camera systems",
      "DVR/NVR solutions",
      "Video analytics",
...
const supportServices = [
  {
    ...
    description: "Professional installation and configuration services for all types of hardware equipment.",
    features: [
  ...
  },
  {
    ...
    description: "Comprehensive maintenance and support services to ensure optimal hardware performance.",
    features: [
  ...
  },
  {
    ...
    description: "Bulk hardware procurement and asset management services for large organizations.",
    features: [
      "Volume purchasing",
      "Asset tracking",
      "Warranty management",
...
const HardwareServices = () => {
  ...
  const { ref: networkingRef, isVisible: networkingVisible } = useScrollAnimation();
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                  ...
                  <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent"> — Complete Infrastructure</span>
                </h1>
                <p className="text-xl text-gray-800 leading-relaxed">
                  Comprehensive hardware services from desktop computers to enterprise servers. We provide end-to-end solutions including procurement, installation, configuration, and ongoing support for all your IT infrastructure needs.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-primary" />
                    <span>Enterprise servers, workstations, and networking equipment</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-primary" />
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-primary" />
                    <span>Professional installation and 24/7 support services</span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Computing Hardware</h2>
            ...
            <p className="text-xl text-gray-800 max-w-3xl">
              High-performance computing solutions for every business need, from individual workstations to enterprise server infrastructure.
            </p>
          </div>

          <div 
            ref={hardwareRef}
            className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 fade-up ${hardwareVisible ? 'visible' : ''}`}
          >
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Networking & Security Solutions</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-primary to-secondary rounded-full mb-6"></div>
            <p className="text-xl text-gray-800 max-w-3xl">
              Advanced networking infrastructure and security hardware solutions to protect and connect your business operations.
            </p>
          </div>

          <div 
            ref={networkingRef}
            className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 fade-up ${networkingVisible ? 'visible' : ''}`}
          >
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Professional Services</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-primary to-secondary rounded-full mb-6"></div>
            <p className="text-xl text-gray-800 max-w-3xl">
              Complete lifecycle support services from initial consultation and installation to ongoing maintenance and support.
            </p>
          </div>

          <div 
            ref={supportRef}
            className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 fade-up ${supportVisible ? 'visible' : ''}`}
          >
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl text-gray-800">
              Contact our hardware experts to discuss your requirements and get a customized solution 
