...
const clientData = [
  { name: "", logo: "/client/client0.1.png" },
  { name: "", logo: "/client/client0.2.png" },
  { name: "", logo: "/client/client0.3.png" },
  { name: "", logo: "/client/client0.4.png" },
  { name: "", logo: "/client/client0.5.png" },
            ...
            {duplicatedClients.map((client, index) => (
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center h-full p-4 relative z-10">
                  <div className={`w-24 h-24 md:w-23 md:h-23 rounded-full bg-gradient-to-br backdrop-blur-sm flex items-center justify-center text-white font-bold text-xl md:text-2xl mb-3  transform group-hover:scale-110 group-hover:blur-sm transition-all duration-500`}>
