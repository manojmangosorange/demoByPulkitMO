      ...
      <div className="w-full px-4 lg:px-6">
        <nav className="flex items-center justify-between h-16 lg:h-20 max-w-7xl mx-auto">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            isActive
          }) => `px-4 py-2 text-foreground hover:text-primary transition-all duration-300 font-medium relative group rounded-lg hover:bg-primary/5 ${isActive ? 'text-primary bg-primary/10' : ''}`}>
              Home
            </NavLink>
            ...
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger onClick={() => navigate('/it-services')} className={`px-4 py-2 text-foreground hover:text-primary bg-transparent hover:bg-primary/5 font-medium data-[state=open]:text-primary data-[state=open]:bg-primary/10 transition-all duration-300 rounded-lg ${isITActive ? 'text-primary bg-primary/10' : ''}`}>
                    IT Services
                    ...
                    <div className="bg-background/98 backdrop-blur-lg border border-border/50 rounded-2xl shadow-2xl p-8">
                      <div className="grid grid-cols-3 gap-8">
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            <Link to="/it-services" className="block text-sm font-medium text-foreground hover:text-primary transition-colors duration-200 py-1 hover:translate-x-1 transform">
                              IT Consulting
                            </Link>
                            <Link to="/it-services" className="block text-sm font-medium text-foreground hover:text-primary transition-colors duration-200 py-1 hover:translate-x-1 transform">
                              System Integration
            ...
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className={`px-4 py-2 text-foreground hover:text-primary bg-transparent hover:bg-primary/5 font-medium data-[state=open]:text-primary data-[state=open]:bg-primary/10 transition-all duration-300 rounded-lg ${isCloudActive ? 'text-primary bg-primary/10' : ''}`}>
